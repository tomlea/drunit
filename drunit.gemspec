...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "README.markdown", "lib/drunit/remote_app.rb", "lib/drunit/remote_test.rb", "lib/drunit.rb", "test/fake_app/fake_app.rb", "test/test_helper.rb", "test/unit/main_test.rb", "bin/drunit_remote"]
  s.has_rdoc = true
  ...
  s.test_files = ["test/unit/main_test.rb"]
